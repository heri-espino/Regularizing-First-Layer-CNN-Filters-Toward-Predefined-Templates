...
For the primary \texttt{two\_concepts}/TinyCNN setting, \Cref{tab:app-metric-pointwise} gives the full pointwise annealed-minus-constant curves under the two alternative output metrics.
...
\Cref{tab:app-architecture-estimates} reports every architecture mean and marginal 95\% $t$ interval for the two pre-specified output metrics.
