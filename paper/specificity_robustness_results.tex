...
\paragraph{Model endpoints for the primary control task.}
To make model competence and filter retention directly inspectable, \Cref{tab:anchor-endpoints} reports mean test accuracy and similarity to each model's own reference bank for the structured and pixel-permuted conditions on \texttt{two\_concepts}. Each entry first averages the four initialization/filter-bank replicates within renderer block and then averages over the 100 blocks. The table also makes clear that the architecture grid is not performance-matched: the GAP variants, especially \texttt{tiny\_gap}, have lower accuracy than the GMP variants.

\begin{table}[h]
\caption{Endpoint audit for the four architectures in the pixel-permuted control on \texttt{two\_concepts}. Similarity is measured against the corresponding reference bank for that row, not always against the original structured bank.}
\label{tab:anchor-endpoints}
\centering
\scriptsize
\setlength{\tabcolsep}{2.5pt}
\begin{tabular}{llrrrr}
\toprule
Architecture & Reference bank & Acc. retention & Acc. release & Similarity retention & Similarity release \\
\midrule
\texttt{tiny\_gmp} & structured & 97.83\% & 99.43\% & 0.943 & 0.573 \\
\texttt{tiny\_gmp} & pixel-permuted & 97.59\% & 99.31\% & 0.936 & 0.563 \\
\texttt{tiny\_gap} & structured & 43.26\% & 79.04\% & 0.999 & 0.590 \\
\texttt{tiny\_gap} & pixel-permuted & 41.17\% & 83.29\% & 0.999 & 0.422 \\
\texttt{plain2\_w16\_gmp} & structured & 99.07\% & 99.31\% & 0.999 & 0.900 \\
\texttt{plain2\_w16\_gmp} & pixel-permuted & 99.21\% & 99.31\% & 0.999 & 0.908 \\
\texttt{plain2\_w16\_gap} & structured & 82.61\% & 92.97\% & 0.974 & 0.731 \\
\texttt{plain2\_w16\_gap} & pixel-permuted & 85.33\% & 92.96\% & 0.961 & 0.668 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{lrrrr}
\toprule
Architecture & Centered-logit diff. & 95\% CI & Probability-error diff. & 95\% CI \\
\midrule
\texttt{tiny\_gmp} & +0.10624 & [0.09645, 0.11602] & +0.19953 & [0.17831, 0.22075] \\
\texttt{tiny\_gap} & +0.07690 & [0.06348, 0.09033] & +0.04308 & [0.03938, 0.04678] \\
\texttt{plain2\_w16\_gmp} & -0.04453 & [-0.05187, -0.03719] & -0.08067 & [-0.10006, -0.06127] \\
\texttt{plain2\_w16\_gap} & +0.09109 & [0.07012, 0.11207] & +0.02057 & [-0.00051, 0.04164] \\
\bottomrule
\end{tabular}
\end{table}
