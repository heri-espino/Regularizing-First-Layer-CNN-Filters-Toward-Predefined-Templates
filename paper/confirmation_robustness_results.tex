...
All entries are annealed minus constant-regularization selected-channel patching scores at epoch 200, paired over 20 new replicates. Only TinyCNN with activation-difference channel selection supplies the single primary test; the remaining rows are prespecified secondary analyses.
...
\caption{Stage-E values of $B$ for every non-reference regularization schedule under activation-difference channel selection.}\label{tab:stage-e-profiles}\\
\toprule
