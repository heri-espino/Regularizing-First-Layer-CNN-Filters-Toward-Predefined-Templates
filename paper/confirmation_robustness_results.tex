...
All entries are annealed minus constant-regularization selected-channel patching scores at epoch 200, paired over 20 new replicates. Only TinyCNN with channels ranked by activation difference supplies the single primary test; the remaining rows are prespecified secondary analyses.
