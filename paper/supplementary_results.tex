...
These earlier analyses precede the pre-specified channel-count experiment reported in \Cref{app:confirmation}. They are retained to show why the primary analysis used the patching effect for selected channels rather than the selected-minus-random comparison.
