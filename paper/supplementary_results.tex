...
The initial 40-epoch analysis compared constant template regularization (\texttt{template\_retention\_1}) with template initialization only (\texttt{template\_init}) at 40 epochs. Four $U$ tests were specified before the Stage-A outcomes were inspected and were Holm-adjusted as one family. Filter-template similarity and accuracy are also reported descriptively.
