...
Stages A--C precede the prespecified confirmatory experiment reported in Appendix~\ref{app:confirmation}. They are retained to show why the confirmatory analysis ultimately used the patching effect for selected channels rather than the selected-minus-random comparison.
