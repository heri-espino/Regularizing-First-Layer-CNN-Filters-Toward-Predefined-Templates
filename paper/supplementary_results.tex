...
Stages A--C precede the prespecified confirmatory experiment reported in Appendix~\ref{app:confirmation}. They are retained because they explain why the final confirmatory analysis was narrowed from a selected-minus-random score to the patching effect for selected channels itself.
